...
class JsonService
{
     ...
     */
    public static function success(string $msg = 'Success', array $data = [], int $code = BusinessErrorCodeEnum::COMMON_SUCCESS, int $show = 1): Json
    {
        $msg = lang($msg);
     ...
     * @date 2021/12/24 18:28
     */
    public static function fail(string $msg = 'Fail', array $data = [], int $code = BusinessErrorCodeEnum::COMMON_ERROR, int $show = 1): Json
    {
        $msg = lang($msg);
        return self::result($code, $show, $msg, $data);
    }
    ...
    {
        return self::success('', $data, BusinessErrorCodeEnum::COMMON_SUCCESS, 0);
    }
     ...
     * @date 2021/12/24 18:29
     */
    public static function throw(string $msg = 'Fail', array $data = [], int $code = BusinessErrorCodeEnum::COMMON_ERROR, int $show = 1): Json
    {
        $msg = lang($msg);
