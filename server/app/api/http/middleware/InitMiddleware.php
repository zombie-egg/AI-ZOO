...
class InitMiddleware
{
    ...
    {
        $maintenance_mode = ConfigService::getFromCache('maintenance_mode', 'open', 0);
        if ($maintenance_mode) {
            $tips = ConfigService::getFromCache('maintenance_mode', 'tips', 'Server is under maintenance, please wait for a while.');
