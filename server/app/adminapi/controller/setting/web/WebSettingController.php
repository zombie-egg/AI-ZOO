...
class WebSettingController extends BaseAdminController
{
    ...
    {
        $result = WebSettingLogic::getBulletinConfig();
        return $this->data($result);
    }
     ...
     */
    public function setBulletinConfig()
    {
        $params = (new WebSettingValidate())->post()->goCheck('setBulletinConfig');
        WebSettingLogic::setBulletinConfig($params);
        return $this->success('设置成功', [], 1, 1);
    }
}