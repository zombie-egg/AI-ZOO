...
class UserController extends BaseAdminController
{
    ...
    {
        $result = (new UserLogic())->getRegisterReward();
        return $this->data($result);
    }
     ...
     * @date 2023/5/23 3:24 下午
     */
    public function setRegisterReward()
    {
        $params = (new UserConfigValidate())->post()->goCheck('setRegisterReward');
        (new UserLogic())->setRegisterReward($params);
        return $this->success('操作成功', [], 1, 1);
    }
}