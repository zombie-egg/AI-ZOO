...
class OfficialAccountReplyValidate extends BaseValidate
{
    ...
    protected $message = [
        ...
        'content_image.requireIf' => '请选择回复图片',
    ];

    protected $scene = [
        'add' => ['reply_type', 'name', 'content_type', 'content', 'status', 'keyword', 'matching_type', 'sort', 'reply_num','content_image'],
        'detail' => ['id'],
        'delete' => ['id'],
        'sort' => ['id', 'new_sort'],
        'status' => ['id'],
        'edit' => ['id', 'reply_type', 'name', 'content_type', 'content', 'status','keyword', 'matching_type', 'sort', 'reply_num','content_image']
    ];
}