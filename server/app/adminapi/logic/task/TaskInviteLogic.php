...
class TaskInviteLogic extends BaseLogic
{
    /**
     * @notes 获取邀请配置
     * @return array
    ...
    {
        ConfigService::set('task_invite', 'status', $params['status']);
        ConfigService::set('task_invite', 'rewards', $params['rewards']);
        ConfigService::set('task_invite', 'max_invite', $params['max_invite']);
