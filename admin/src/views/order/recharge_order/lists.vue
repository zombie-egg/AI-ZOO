<template>
  ...
  <el-card class="!border-none mt-4" shadow="never">
    <el-table size="small" v-loading="pager.loading" :data="pager.lists">
      ...
      <el-table-column label="产品张数" prop="draw_number" min-width="100" />
      <el-table-column
        label="充值套餐"
        min-width="180"
        prop="recharge_package_name"
      >
      </el-table-column>
      <el-table-column
        label="支付方式"
      ...
      <el-table-column label="是否免费" prop="is_free_text" min-width="100" />
      <el-table-column label="免费方式" prop="free_type" min-width="120" />
      <el-table-column
        label="上次登录IP"
        prop="login_ip"
        min-width="140"
      ...
      <el-table-column label="操作" width="100" fixed="right">
        <template #default="{ row }">
          <div class="flex items-center">
            <el-button
              v-perms="['recharge.recharge_order/detail']"
              type="primary"
              link
