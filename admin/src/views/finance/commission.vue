  ...
  <div>
    ...
    <el-card class="!border-none mt-4" shadow="never">
      <el-table size="large" v-loading="pager.loading" :data="pager.lists">
        ...
        <el-table-column label="结算时间" prop="create_time" min-width="120" />
      </el-table>
...
import { getMoneyChangeType, accountLog } from "@/api/finance";
