<template>
  ...
  <el-card shadow="never" class="!border-none mt-4">
    ...
    <el-table size="large" :data="pager.lists" class="mt-4">
      ...
      <el-table-column label="套餐描述" min-width="200" prop="describe">
      </el-table-column>
      ...
      <el-table-column label="对话次数" min-width="100" prop="number">
      </el-table-column>
      <el-table-column label="绘画次数" min-width="100" prop="draw_number">
      </el-table-column>
      <el-table-column label="额外赠送" min-width="100">
        <template #default="{ row }">
          <el-tag v-if="row.is_give == 1" type="success">{{
            row.is_give_desc
          }}</el-tag>
          <el-tag v-if="row.is_give == 0" type="danger">{{
            row.is_give_desc
          }}</el-tag>
        </template>
      </el-table-column>
