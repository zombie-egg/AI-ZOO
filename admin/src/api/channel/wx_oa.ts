...
export function setOaConfig(params: any) {
  return request.post({
    url: "/channel.official_account_setting/setConfig",
    params,
  });
}
...
export function setOaMenuPublish(params: Menu | any) {
  return request.post({
    url: "/channel.official_account_menu/saveAndPublish",
    params,
  });
}
...
export function oaReplyDel(params: { id: number }) {
  return request.post({
    url: "/channel.official_account_reply/delete",
    params,
  });
}
...
export function changeOaReplyStatus(params: { id: number }) {
  return request.post({
    url: "/channel.official_account_reply/status",
    params,
  });
}
